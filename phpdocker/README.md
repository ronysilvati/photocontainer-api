...
------|---------|-----------
Webserver|[localhost:8081](http://localhost:8081)|[192.168.33.68](http://192.168.33.68)
...
------|---------|-----------
php-fpm|photocontainer-api-php-fpm|9000
MySQL|photocontainer-api-mysql|3306 (default)
...
**Note 2:** if you're using Vagrant, you'll need to ssh into it first
  ...
  * Execute command inside of container: `docker exec -it photocontainer-api-php-fpm COMMAND` where `COMMAND` is whatever you want to run. For instance, `/bin/bash` to open a console prompt.
